...
<Picture
  ...
  sourceLink=""
  alt="A man sitting on a chair, surrounded by shadow and looking down the lens."
  focalPoint={{
    mobile: { x: 0.6, y: 0 },
    tablet: { x: 0.6, y: 0 },
...
<Pullquote
  className=""
  quote="There were, like, around 15 boys locked up there, with chains on their legs, big chains."
/>
...
<Pullquote
  className=""
  quote="There was nothing to do, just every day wake up, sit, stand, sit, sleep, like that. "
/>
...
<figure className="not-prose my-10">
  <div className="mx-auto max-w-[600px] px-8 font-base">
    <div className="message_bubble message_bubble_right relative my-4 mx-auto rounded-b-lg rounded-l-lg bg-[#e2ffc7] p-3 pb-5 text-neutral-900 opacity-100 drop-shadow-lg text-lg md:text-2xl">
      <p>
        I cannot bear this life any longer, and they might find out anytime that
        I am talking to you. I will jump from the third floor tonight, please
        come and help.
      </p>
...
<ScrollSection className="my-12" pinType="pin_clipped">
  ...
  <ScrollForeground className="">
    <ScrollTextChapter className="chapter_dark_background" position="center">
      On the way to a safe house, he discovered the compound manager had put a
      US$20,000 bounty on his head.
    </ScrollTextChapter>
...
<Pullquote
  className=""
  quote="We were only allowed to download certain apps for scam purposes. Sometimes they let us use our personal phones to send messages to family, but the manager would be there watching us"
/>
...
<Pullquote
  ...
  endQuoteIcon={true}
  quote="After my family paid a ransom for me, they gave back my phone but cleaned everything inside. So, I don't have any evidence to prove that they trafficked me."
/>
...
<Image
  ...
  loading="lazy"
  alt="Sihanoukville, Cambodia, seen from the outskirts."
  source="Photo: Roun Ry"
  caption="Sihanoukville, Cambodia, seen from the outskirts."
/>{" "}
...
Alice, a Taiwanese victim we met in [part one](https://scam-factories-life-inside.netlify.app/) of our series, was repeatedly raped inside scam compounds. When she returned home, she was accused of being greedy and naïve.

<Pullquote
  className=""
  quote="I felt so depressed when one of my best friends called me stupid."
  startQuoteIcon={true}
  endQuoteIcon={false}
/>
...
<Pullquote
  className=""
  quote="He thought I had fallen into the trap because I wanted to be paid a lot of money without considering if I was qualified for it. I told him it was not true."
  startQuoteIcon={false}
  endQuoteIcon={true}
/>

These kinds of binary judgements aren't particularly helpful because the line between victim and perpetrator is not always clear cut. Criminologists call it the “[victim-offender overlap](https://link.springer.com/article/10.1007/s12117-024-09525-5)”.
...
<Image
  ...
  imgClassName="aspect-[3/2]"
  loading="lazy"
  alt="The view of scam compounds from Otres Beach, Sihanoukville, Cambodia."
  source="Photo: Roun Ry"
  caption="The view of scam compounds from Otres Beach, Sihanoukville, Cambodia."
/>{" "}
...
Crucially, groups on the ground rescuing and helping survivors, and those monitoring the industry, are in dire need of resources. Many are now at risk of collapse after US President Donald Trump's decision [to gut](https://apnews.com/article/cambodia-scam-compound-shelter-us-funding-freeze-6bc436aeffd46c47b049413e73987d14) the US Agency for International Development (USAID), which has been a key funder of anti-trafficking work. Ling's own work helping scam workers after they've been rescued has been put on hold.
  ...
  <ScrollForeground className="">
    <ScrollTextChapter position="" className="">
      <Pullquote
        ...
        quote="If I had been enslaved for a year or two, I might not be able to believe in humanity anymore."
        startQuoteIcon={true}
        endQuoteIcon={false}
    ...
    <ScrollTextChapter position="" className="">
      <Pullquote
        className="text-white"
        quote="People outside, including my own family, think that I was trafficked because I am greedy and wanted to get rich overnight. So, I need to tell my story."
        startQuoteIcon={false}
        endQuoteIcon={true}
        quoteClassname="opacity-20"
      />
...
<img
  src="https://counter.theconversation.com/content/250517/count.gif?distributor=republish-lightbox-advanced"
