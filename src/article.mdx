...
<img src="https://counter.theconversation.com/content/250517/count.gif?distributor=republish-lightbox-advanced" alt="The Conversation" className='!border-0 !shadow-none !m-0 !max-h-[1px] !max-w-[1px] !min-h-[1px] !min-w-[1px] !opacity-0 !outline-none !p-0 w-px h-px' referrerPolicy='no-referrer-when-downgrade' />
