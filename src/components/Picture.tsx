...
export default function Picture({
  ...
  const sizingParams: Record<string, SizingParams> = {
    mobile: {
      ar: "3:4",
      "fp-x": focalPoint.mobile.x,
      "fp-y": focalPoint.mobile.y,
    },
    tablet: {
      ar: "1:1",
      "fp-x": focalPoint.tablet.x,
      "fp-y": focalPoint.tablet.y,
    },
    tabletLandscape: {
      ar: "4:3",
      "fp-x": focalPoint.tabletLandscape.x,
      "fp-y": focalPoint.tabletLandscape.y,
    },
    laptop: {
      ar: "16:9",
      "fp-x": focalPoint.laptop.x,
      "fp-y": focalPoint.laptop.y,
    },
    desktop: {
      ar: "16:9",
      "fp-x": focalPoint.desktop.x,
      "fp-y": focalPoint.desktop.y,
    },
  };
